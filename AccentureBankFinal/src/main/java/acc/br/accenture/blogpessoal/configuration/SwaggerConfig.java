package acc.br.accenture.blogpessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("acc.br.accenture.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Accenture Bank")
			.description("Projeto Spring - Accenture Bank")
			.version("1.0.0")
